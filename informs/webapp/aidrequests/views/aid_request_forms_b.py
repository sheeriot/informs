...
class AidRequestCreateFormB(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name, field in self.fields.items():
            if field.required:
                if field_name != 'aid_type':
                    field.widget.attrs['style'] = 'background-color: #FFFBEA !important;'
        ...
        self.helper.layout = Layout(
            ...
            'latitude', 'longitude', 'location_note', 'location_modified',
            Fieldset(
                "Type of Aid Needed",
            ...
            Fieldset(
                "Who Needs Aid",
                Row(
                    Column('full_name', css_class='col-md-6 mb-1'),
                    Column('contact_info', css_class='col-md-6 mb-1'),
                ),
                Row(
                    ...
                    Column(
                        HTML("""
                            <div class="d-flex align-items-center">
                                <button type="button" id="get-location" class="btn btn-danger btn-sm text-nowrap me-2">
                                    <i class="bi bi-phone"></i> My Location
                                </button>
                                <strong>Please Confirm your Location below.</strong>
                            </div>
                        """),
                        css_class='col-auto'
                    ),
                ...
                HTML(f"""
                    <div class="row g-0 mt-2">
                        <div class="form-group col-md-12 p-1" style="position: relative;">
                            ...
                            <div style="position: absolute; top: 10px; left: 55px; z-index: 10;">
                                <button type="button" id="confirm-location" class="btn btn-success btn-sm d-none text-nowrap">
            ...
            Fieldset(
                ...
                'aid_description',
                HTML('<p class="mt-2">Check all that apply:</p>'),
                Row(
