...
urlpatterns = [
     ...
     path('<slug:field_op>/aid_request/', AidRequestCreateView.as_view(), name='aid_request_create'),
     path('<slug:field_op>/aid_request/list/', AidRequestListView.as_view(), name='aid_request_list'),
     path(
          '<slug:field_op>/aid_request/<int:pk>/update/',
     ...
     #      ),
     path(
          '<slug:field_op>/aid_request/<int:pk>/',
          AidRequestDetailView.as_view(),
          name='aid_request_detail'
          ),
     path(
          '<slug:field_op>/aid_request/export-csv/',
          AidRequestCsvView.as_view(),
          {'action': 'export_csv'},
          name='aid_requests_csv'
          ),
     path(
          '<slug:field_op>/aid_request/<int:pk>/geocode',
          AidLocationCreateView.as_view(),
          name='aid_request_geocode'
          ),
     path(
          '<slug:field_op>/aid_request/<int:aid_request>/location/<int:pk>/delete',
          AidLocationDeleteView.as_view(),
          name='aid_location_delete'
          ),
     path(
          '<slug:field_op>/aid_request/<int:pk>/addlog',
